...
//    }
    ...
    public void testSetItemDataSource() {
        ...
        // TODO review the generated test code and remove the default call to fail.
        assertEquals(((StatutApprobation) ((BeanItem) instance.getItemDataSource()).getBean()).getCode(), "B");
        assertEquals(((StatutApprobation) ((BeanItem) instance.getItemDataSource()).getBean()).getDescription(), "Build");
    }
    ...
    public void testSetBOForRead() {
        ...
        // TODO review the generated test code and remove the default call to fail.
        assertEquals(((StatutApprobation) abstractBO).getCode(), ((StatutApprobation) instance.getAbstractBO()).getCode());
        assertEquals(((StatutApprobation) abstractBO).getDescription(), ((StatutApprobation) instance.getAbstractBO()).getDescription());
