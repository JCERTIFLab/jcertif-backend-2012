 ...
 * 
 */
public class CommunityGroupsDetailComponent extends Panel {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(CommunityGroupsDetailComponent.class);
	 ...
	 *            a event
	 */
	public CommunityGroupsDetailComponent() {
		super();
		update();
	...
	public void update() {
		...
		for (Participant participant : participantList) {
			...
			// Entete
			if (isFirsTime) {
			htmlLayout.addComponent(new Label(Msg.get("ui.community.title")), "caption");
			htmlLayout.addComponent(new Label(Msg.get("ui.community.description")),
			"captionDetail");
			}
