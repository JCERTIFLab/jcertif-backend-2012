/*Vaadin Trac
 ...
 source: versions/6.4/demo/src/com/vaadin/demo/sampler/ExampleUtil.java @ 12664
 View revision:
 Visit:
 Revision 12664, 19.8 KB checked in by john.ahlroos@…, 12 months ago (diff)

 Added sample for #4571
 Line	 
 */
...
public final class PaysUtility {
	...
	private static final String[] iso3166 = new String[] { "AFGHANISTAN", "AF", "ILAND ISLANDS",
	...
	"Joe", "Sarah", "Jeff", "Jane", "Peter", "Marc", "Robert", "Paula", "Lenny", "Kenny", "Nathan",
	...
	private static final String[] orderDescriptions = new String[] { "Email Box", "Domain Name",
			"Technical Support", "E-Commerce Setup", "Web Hosting", "SSL Certificate" };
	...
	public static IndexedContainer getOrderContainer() {
		...
		addOrderToContainer(container, "Email Box", 0, 0.15);
		addOrderToContainer(container, "E-Commerce Setup", 1, 5.00);
