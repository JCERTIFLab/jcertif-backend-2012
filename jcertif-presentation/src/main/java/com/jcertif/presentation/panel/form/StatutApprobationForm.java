...
public class StatutApprobationForm extends AbstractForm<StatutApprobation, StatutApprobationAction> {

    private GridLayout ourLayout;

    public StatutApprobationForm(StatutApprobationAction action) {
        super(action);
        setCaption("Statut Approbation");
    ...
    public List<Object> getColumnOrder() {
        return Arrays.asList(StatutApprobationContainer.NATURAL_COL_ORDER);
    }
}
