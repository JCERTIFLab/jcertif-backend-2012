...
public class ParticulariteSalleForm extends AbstractForm<ParticulariteSalle, ParticulariteSalleAction> {

    private GridLayout ourLayout;

    public ParticulariteSalleForm(ParticulariteSalleAction action) {
        super(action);
        setCaption("Particularite Salle");
    ...
    public List<Object> getColumnOrder() {
        return Arrays.asList(ParticulariteSalleContainer.NATURAL_COL_ORDER);
    }
}
