...
public class TypeParticipantForm extends AbstractForm<TypeParticipant, TypeParticipantAction> {

    private GridLayout ourLayout;

    public TypeParticipantForm(TypeParticipantAction action) {
        super(action);
        setCaption("Type Participant");
    ...
    public List<Object> getColumnOrder() {
        return Arrays.asList(TypeParticipantContainer.NATURAL_COL_ORDER);
    }
}
