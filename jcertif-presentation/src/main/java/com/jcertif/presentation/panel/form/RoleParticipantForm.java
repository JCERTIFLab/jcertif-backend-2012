...
public class RoleParticipantForm extends AbstractForm<RoleParticipant, RoleParticipantAction> {

    private GridLayout ourLayout;

    public RoleParticipantForm(RoleParticipantAction action) {
        super(action);
        setCaption("Role Participant");
    ...
    public List<Object> getColumnOrder() {
        return Arrays.asList(RoleParticipantContainer.NATURAL_COL_ORDER);
    }
}
