...
public class FaqClient extends AbstractJCertWebServiceClient<Faq, Long> {
	...
	@Override
	public List<Faq> findAll_JSON() throws UniformInterfaceException, ClientHandlerException {
	...
	@Override
	public List<Faq> findAllXML() throws UniformInterfaceException, ClientHandlerException {
		return getWebResource().path(FINDALL_SUFFIX)
