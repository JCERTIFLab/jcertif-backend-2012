...
/**
 * 
 * @author Douneg Classe permettant de faire la liaison entre une interface et
 *         un container Elle permet aussi de faire la liaison entre l'interfae
 *         le container et le client du service web permettant d'attaquer la
 *         couche metier
 */
public abstract class AbstractAction<PC extends AbstractJCertifBeanItemContainer, BO extends AbstractBO, WS extends AbstractJCertWebServiceClient> {
	...
	public ComboBox createCombobox(String caption) {
		...
		ComboBox l = new ComboBox(caption, getPrincipalContainer());
