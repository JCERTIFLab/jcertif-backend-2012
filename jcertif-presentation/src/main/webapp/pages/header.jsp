...
<div id="header">
    ...
    <div id="menu">
	    ...
	    <li><a id="menu_propositionlist" href="<%=request.getContextPath()%>/pages/propositionlist.jsp" title=""><b><%=session.getAttribute("header.jsp.menu.propositionlist")%></b></a></li>
