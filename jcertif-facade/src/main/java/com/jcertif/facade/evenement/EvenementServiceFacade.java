package com.jcertif.facade.evenement;
...
public class EvenementServiceFacade {
	...
	public Evenement createEvenementFacade(Evenement evenement) {
		LOG.debug("Creation d'un nouvel �venement: {}", evenement.getNomEvenement() + " "+evenement.getId());
		return evenementService.createEvenement(evenement);
	}

	/**
	 * service qui retourne la liste des �v�nements
	 * 
	 * @return
	 */
	@GET
	...
	/**
	 * Permet d etrouver un �v�nement en fonction de son id
	 * 
	 * @param key
	 * @return
	 */
	...
	/**
	 * permet de mettre � jour un �v�nement
	 * @param evenement
	 * @return
	 */
	@PUT
	...
	/**
	 * Supprime un �v�nement de la base
	 * @param evenement
	 */
	@DELETE
